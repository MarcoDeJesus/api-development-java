...
public class ActivityResource {
	...
	@PUT
	@Path("{activityId}") // http://localhost:8080/exercise-services/webapi/activity
	@Consumes({MediaType.APPLICATION_JSON})
	@Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
	...
	@POST
	@Path("activity") // http://localhost:8080/exercise-services/webapi/activity
	@Consumes({MediaType.APPLICATION_JSON})
	@Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
...
//		System.out.print("Getting activity ID: "+ activityId);
